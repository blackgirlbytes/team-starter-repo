---
name: audit-all
description: Orchestrate selected audit roles with fresh sub-agents, configurable model tier, and optional --dry-run/--debug validation. Use when running full multi-role audits.
---
...
1. Principal Engineer -> `.cursor/skills/audit-principal/SKILL.md`
2. Security Auditor -> `.cursor/skills/audit-security/SKILL.md`
3. DevOps Engineer -> `.cursor/skills/audit-devops/SKILL.md`
4. Accessibility Auditor -> `.cursor/skills/audit-a11y/SKILL.md`
5. Patterns Auditor -> `.cursor/skills/audit-dry/SKILL.md`

## Hard Rules

- Use `AskQuestion` for all runtime choices.
- Use `Subagent` workers for all selected roles.
- Max 4 concurrent workers at a time.
